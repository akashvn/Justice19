    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="indexViewOnly.php">Bellarmine Justice Summit</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="indexViewOnly.php">Session View</a></li>
      ...
      <div class="row">
        ...
        <div class="col-sm-7">
          ...
          <div id="registration-incomplete-alert" class="alert alert-danger" role="alert">
            If you are not registered for all three sessions, please contact me ASAP by <a class="alert-link" href="mailto:marcus.ma20@bcp.org?subject=Justice+Summit+App">clicking here</a>.
          </div>

          <div id="registration-complete-alert" class="alert alert-success" role="alert">
            You are registered for all three breakout sessions. Session selections can no longer be changed via this page. If you need a change (to planned absence, or if you are presenting a session and you don't have it assigned), please <a class="alert-link" href="mailto:marcus.ma20@bcp.org?subject=Justice+Summit+App">email me</a>.
          </div>
