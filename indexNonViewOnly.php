      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>This website lets you register for breakout sessions for the <strong>2019 Justice Summit on Gender</strong> at Bellarmine. Breakout sessions are built into the Bellarmine schedule for the week of January 28th. Sessions in Blocks 1 and 2 (held on Tuesday, January 29th) will be presented by Bellarmine faculty and students, and sessions in Block 3 and 4 (held on Wednesday, January 30th) will be presented by guests to our campus.<br /><br />Use the tabs at the top to switch between blocks. Click/tap on sessions to see details and register. All changes are saved automatically.<br /><br />If you are <strong>presenting one or two sessions</strong>, please select your own session(s). If you have or will have a <strong>planned absence</strong> for Tuesday, select the "Planned Absence" session for Blocks 1 and 2; do the same for Block 3 if you are missing Wednesday.<br /><br />If you have any questions or need help, please contact us by <a href="mailto:jeffrey.ma18@bcp.org?subject=Justice+Summit+App">clicking here</a>. If you need to reach this popup again, select the "Help" tab at the top of the page.<br /><br /><a href="https://instagram.com/jeepartb" target="_blank">@JeffMa</a> <br /><a href="https://instagram.com/will.portman" target="_blank">@WillPortman</a></p>
          </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="completeModal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>You have been successfully registered for all three breakout session blocks. You may freely close this website at any time and your session schedule with room numbers will be emailed to you next week. You may also make changes to any parts of your schedule as you'd like, through the end of this week.</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
          </div>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="indexNonViewOnly.php">Bellarmine Justice Summit</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="indexNonViewOnly.php">Session Registration</a></li>
    ...
    <div class="container" id="top">
      ...
      <div class="row">
            ...
            <div class="panel-body">
              ...
              <table class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  $blocktimes = array(
                    "1" => "1/29, Tuesday, 10:20-11:10",
                    "2" => "1/29, Tuesday, 11:20-12:10",
                    "3" => "1/30, Wednesday, 10:20-11:10",
					"4" => "1/30, Wednesday, 11:20-12:10"
        ...
        <div class="col-sm-8"> <!-- Right 2/3 of page, session list -->
          ...
          <h2>2019 Breakout Session Selection</h2>
